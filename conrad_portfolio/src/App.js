...
function App() {
  ...
  let homeCont = "I am a full stack web developer and recent graduate of Flatiron School's software engineering program. I specialize in  Ruby, Rails, React, and JavaScript. I am currently pursuing AWS cloud practicioner certification to show that I can implement cloud based solutions effectively using AWS. I am also currently learning Python to further diversify my skillset. I enjoy the outdoors and I am a talented mechanic and metal fabricator. I want to use my love for building and fixing things to create and optimize scalable, and lasting web solutions. My background as a lab analyst has familiarized me with a fast paced and dynamic work environment where creativity combined with technical ability and colloboration skills are paramount. I enjoy learning and am always working on something. Feel free to reach out on linked in if you are curious as to what I am working on right now! Thanks for visiting my portfolio!"
  let projects = [
    { points: [
